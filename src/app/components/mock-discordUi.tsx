      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="ml-auto flex items-center space-x-4 text-[#b9bbbe]">
            <Phone className="size-5 hover:text-white cursor-not-allowed sm:blocked" />
            <Video className="size-5 hover:text-white cursor-not-allowed sm:blocked" />
            <Pin className="size-5 hover:text-white cursor-not-allowed sm:blocked" />
            <UserCircle className="size-5 hover:text-white cursor-not-allowed sm:blocked" />
            <Search className="size-5 hover:text-white cursor-not-allowed sm:blocked" />
            <Inbox className="size-5 hover:text-white cursor-not-allowed sm:blocked" />
            <HelpCircle className="size-5 hover:text-white cursor-not-allowed sm:blocked" />
          </div>
        </div>
